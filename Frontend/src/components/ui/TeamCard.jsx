        ...
        >
            ...
            <div className="mb-4 flex items-start justify-between">
                <div className="flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#FDB913] to-[#f7953f] shadow-md">
                        <Users size={24} className="text-white" />
                    </div>
                    <div>
                        <h3 className="text-lg font-bold text-[#333333] group-hover:text-[#f7953f] transition-colors">
                            {team.team_name}
                        </h3>
                ...
                <Megaphone size={20} className="text-gray-400 group-hover:text-[#f7953f] transition-colors" />
            </div>
                ...
                <div className="mb-4 space-y-3">
                    ...
                    <div className="rounded-md border border-gray-200 bg-gray-50 p-3">
                        ...
                        <div className="flex items-center justify-between gap-2">
                            <code className="rounded-md bg-white px-3 py-1.5 font-mono text-sm font-bold text-[#f7953f] border border-gray-200">
                                {team.join_code}
                            </code>
                            <div className="flex gap-1">
                                <button
                                    ...
                                    disabled={loading}
                                    className="rounded-md p-2 text-gray-600 transition-all hover:bg-white hover:text-[#f7953f] focus:outline-none focus:ring-2 focus:ring-[#f7953f]/50 disabled:opacity-50 disabled:cursor-not-allowed"
                                    title="Copy code"
                                >
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="flex items-center justify-between text-sm text-gray-600 group-hover:text-[#f7953f] transition-colors">
